...
class BolusCalculatedPart1EventParserTest {
    ...
    fun parseEvent() {
        ...
        val testEvent = EventInfo(EventType.BOLUS_CALCULATED_PART_1_OF_2, 1, 2)
        val expected = HistoryEvent(EventInfo(EventType.BOLUS_CALCULATED_PART_1_OF_2, 1, 2),
